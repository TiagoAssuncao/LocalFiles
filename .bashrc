...
#######################################################
alias pycon='jupyter-console'

alias att='apt-get -f install && apt-get upgrade && apt-get update'

alias att2='apt-get -f install -y && apt-get upgrade -y && apt-get update -y && apt-get -f install -y && apt-get upgrade -y && apt-get update -y'
